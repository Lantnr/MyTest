...
namespace TGM.API.Entity
{
    ...
    public partial class tgm_notice : Entity<tgm_notice>
    {
		#region 扩展连接
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}[{1}]数据……", typeof(tgm_notice).Name, Meta.Table.DataTable.DisplayName);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}[{1}]数据！", typeof(tgm_notice).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        public static tgm_notice FindByid(Int64 __id)
        {
            //if (Meta.Count >= 1000)
        ...
        //public static EntityList<tgm_notice> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
