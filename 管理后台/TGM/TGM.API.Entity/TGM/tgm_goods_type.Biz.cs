...
namespace TGM.API.Entity
{
    ...
    public partial class tgm_goods_type : Entity<tgm_goods_type>
    {
		#region 扩展连接
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}[{1}]数据……", typeof(tgm_goods_type).Name, Meta.Table.DataTable.DisplayName);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}[{1}]数据！", typeof(tgm_goods_type).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        public static tgm_goods_type FindByid(Int32 __id)
        {
            //if (Meta.Count >= 1000)
        ...
        //public static EntityList<tgm_goods_type> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
