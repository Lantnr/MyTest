...
{
    /// <summary>每日记录表</summary>
    [DataObject]
    [Description("每日记录表")]
    [BindIndex("PK__tgm_reco__3213E83F489AC854", true, "id")]
    [BindTable("tgm_record_day", Description = "每日记录表", ConnName = "DB", DbType = DatabaseType.SqlServer)]
    public partial class tgm_record_day : Itgm_record_day
    {
        #region 属性
        private Int64 _id;
        /// <summary>编号</summary>
        ...
        [Description("今日充值")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(13, "pay_taday", "今日充值", "0", "int", 10, 0, false)]
        ...
        [Description("总充值")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(14, "pay_total", "总充值", "0", "int", 10, 0, false)]
        ...
        [Description("月充值")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(15, "pay_month", "月充值", "0", "int", 10, 0, false)]
        ...
        [Description("今日充值次数")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(17, "pay_count", "今日充值次数", "0", "int", 10, 0, false)]
        ...
        #region 字段名
        /// <summary>取得每日记录表字段信息的快捷方式</summary>
        ...
        /// <summary>取得每日记录表字段名称的快捷方式</summary>
        partial class __
        {
            ///<summary>编号</summary>
    ...
    /// <summary>每日记录表接口</summary>
    public partial interface Itgm_record_day
    {
        #region 属性
        /// <summary>编号</summary>
        Int64 id { get; set; }
