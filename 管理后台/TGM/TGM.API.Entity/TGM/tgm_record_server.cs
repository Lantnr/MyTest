...
{
    /// <summary>游戏服务器统计记录</summary>
    [DataObject]
    [Description("游戏服务器统计记录")]
    [BindIndex("PK__tgm_reco__3213E83F7F2BE32F", true, "id")]
    [BindTable("tgm_record_server", Description = "游戏服务器统计记录", ConnName = "DB", DbType = DatabaseType.SqlServer)]
    public partial class tgm_record_server : Itgm_record_server
    {
        #region 属性
        private Int64 _id;
        /// <summary></summary>
        ...
        [Description("游戏服务器编号")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(3, "sid", "游戏服务器编号", "0", "int", 10, 0, false)]
        ...
        #region 字段名
        /// <summary>取得游戏服务器统计记录字段信息的快捷方式</summary>
        ...
        /// <summary>取得游戏服务器统计记录字段名称的快捷方式</summary>
        partial class __
        {
            ///<summary></summary>
    ...
    /// <summary>游戏服务器统计记录接口</summary>
    public partial interface Itgm_record_server
    {
        #region 属性
        /// <summary></summary>
        Int64 id { get; set; }
