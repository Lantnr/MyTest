...
namespace TGG.Module.Work.Service
{
    ...
    /// 工作更新和领取奖励
    /// </summary>
    public class WORK_UPDATE : IDisposable
    {
        ...
        public void WatchEnd(Int64 task_id)
        {
            ...
            new WORK_FIGHT_PUSH().CommandStart(session, null, (int)TaskWatchType.FINISH);
        }
        ...
        public bool KillWatch(List<Variable.UserTaskInfo> watchlist, Int64 userid)
        {
            ...
            if (fightvo.isWin == false)
            {
                ...
                new WORK_FIGHT_PUSH().CommandStart(watchse, fightvo, (int)TaskWatchType.LOSE);
            }
            else
            {
                ...
                kill.KillNpcid = 0;
                watch.WatchNpcid = 0;
                new WORK_FIGHT_PUSH().CommandStart(watchse, fightvo, (int)TaskWatchType.WIN);
            }
            return true;
        }
