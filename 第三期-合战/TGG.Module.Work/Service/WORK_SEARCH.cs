...
namespace TGG.Module.Work.Service
{
    ...
    /// 搜寻宝物验证
    /// </summary>
    public class WORK_SEARCH : IDisposable
    {
        ...
        #endregion
        //public static WORK_SEARCH ObjInstance;

        ///// <summary> TASK_SEARCH单体模式 </summary>
        //public static WORK_SEARCH GetInstance()
        //{
        //    return ObjInstance ?? (ObjInstance = new WORK_SEARCH());
        //}
        ...
        private void CheckIsInPrison(Int64 userid)
        {
            ...
            WorkInfo.SearchFailTimes++;
            if (WorkInfo.SearchFailTimes < 3) return;
