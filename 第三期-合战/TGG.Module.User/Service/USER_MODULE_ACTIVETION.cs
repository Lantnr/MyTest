...
namespace TGG.Module.User.Service
{
    ...
    /// 模块激活指令
    /// </summary>
    public class USER_MODULE_ACTIVETION : IDisposable
    {
        ...
        public ASObject CommandStart(TGGSession session, ASObject data)
        {
            ...
            catch (Exception ex) { XTrace.WriteException(ex); return ResultData((int)ResultType.DATABASE_ERROR); }
