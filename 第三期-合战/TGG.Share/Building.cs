...
namespace TGG.Share
{
    ...
    public class Building
    {
        ...
        public bool Init()
        {
            ...
            if (baserule == null || baserule1 == null || baserule2 == null) return false;
            ...
            if (fightrole == null) return false;
            ...
            if (!baseinfo.Contains(',')) return false;
            ...
            if (baseinfo1 == null) return false;
            if (!baseinfo1.Contains(',')) return false;
