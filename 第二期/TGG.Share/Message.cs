...
namespace TGG.Share
{
    ...
    public partial class Message
    {
        ...
        public void BuildMessagesSend(Int64 userid, string title, string contents, string attachment)
        {
            ...
            (new Log()).WriteLog(userid, (int)LogType.Insert, (int)ModuleNumber.MESSAGES, (int)MessageCommand.MESSAGE_PUSH, temp);
            UnMessage(userid);
        }
        ...
        /// <param name="list">奖励集合</param>
        private string GetAttachment(IEnumerable<RewardVo> list)
        {
