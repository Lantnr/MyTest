...
namespace TGG.Module.Task.Service
{
    ...
    /// 开发者：李德雁
    /// </summary>
    public class TASK_VOCATION_UPDATE
    {
        ...
        public ASObject CommandStart(TGGSession session, ASObject data)
        {
            ...
            new Share.Log().WriteLog(userid, (int)LogType.Delete, (int)ModuleNumber.TASK, (int)TaskCommand.TASK_VOCATION_UPDATE, logdata);
        ...
        {
            var mysteplist = Common.getInstance().SplitTaskToList(task.task_step_data);
            var basesteplist = Common.getInstance().SplitTaskToList(basestep);
