...
namespace TGG.Module.Fight.Service
{
    ...
    public partial class FIGHT_PERSONAL_ENTER
    {
        ...
        public void Attack(FightRole attackrole, bool flag)
        {
        ...
        public bool NormalAttack(FightRole attackrole)
        {
            var flag = false;
        ...
        public bool IsDuck(FightRole defenserole)
        {
        ...
        public void ByEffect(FightRole attackrole, FightRole defenserole, Int64 number, bool flag)
        {
            var movesvo = move.CloneDeepEntity();
        ...
        /// <param name="defenserole">防守武将</param>
        /// <param name="flag">是否暴击</param>
        public Int64 DamageCount(FightRole attackrole, FightRole defenserole, ref bool flag)
        {
