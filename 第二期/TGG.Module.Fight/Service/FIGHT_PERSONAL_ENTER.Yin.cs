...
namespace TGG.Module.Fight.Service
{
    ...
    public partial class FIGHT_PERSONAL_ENTER
    {
        ...
        /// <summary> 印效果 </summary>
        public void YinEffect(YinVo yinvo, int yincount)
        {
        ...
        public bool IsActivation(int baseyincount, int yincount)
        {
        ...
        public void DeductionYinCount(decimal userid, int number)
        {
