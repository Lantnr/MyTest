...
namespace TGG.Core.Entity
{
    ...
    [DataObject]
    [Description("")]
    [BindTable("view_ting_not_car", Description = "", ConnName = "DB", DbType = DatabaseType.SqlServer, IsView = true)]
    public partial class view_ting_not_car : Iview_ting_not_car
    {
        #region 属性
        private Int64 _id;
        /// <summary></summary>
        ...
        [BindColumn(3, "ting_id", "", null, "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(4, "state", "", null, "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(5, "area_id", "", null, "int", 10, 0, false)]
        ...
        #region 字段名
        /// <summary>取得Ting_Not_Car字段信息的快捷方式</summary>
        ...
        /// <summary>取得Ting_Not_Car字段名称的快捷方式</summary>
        partial class __
        {
            ///<summary></summary>
    ...
    /// <summary>Ting_Not_Car接口</summary>
    /// <remarks></remarks>
    public partial interface Iview_ting_not_car
    {
        #region 属性
        /// <summary></summary>
        Int64 id { get; set; }
