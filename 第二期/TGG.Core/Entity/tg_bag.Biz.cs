...
{
    /// <summary>背包表</summary>
    public partial class tg_bag : Entity<tg_bag>
    {
        #region 对象操作
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}[{1}]数据……", typeof(tg_bag).Name, Meta.Table.DataTable.DisplayName);
        ...
        //    entity.baptize_count = 0;
        //    entity.Insert();

        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}[{1}]数据！", typeof(tg_bag).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        public static tg_bag FindByid(Int64 __id)
        {
            //if (Meta.Count >= 1000)
        ...
        //public static EntityList<tg_bag> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
